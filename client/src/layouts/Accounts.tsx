...
function Accounts() {
  ...
  return (
    <>
     ...
     <div className="mx-24 my-5 h-[75vh] grid grid-rows-[auto,1fr] gap-6 items-center max-w-screen-xl">
     ...
     <div className="border-[1px] h-full rounded-md grid grid-rows-[1fr,auto]">
